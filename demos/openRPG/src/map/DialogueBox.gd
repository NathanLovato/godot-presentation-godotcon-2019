...
onready var name_label : = get_node("Panel/Name") as Label
onready var text_label : = get_node("Panel/Text") as Label

onready var button_next : = get_node("Panel/ButtonNext") as Button
onready var button_finished : = get_node("Panel/ButtonFinished") as Button

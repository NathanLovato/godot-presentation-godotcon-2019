...
var HookableLifebar = preload("res://demos/openRPG/src//combat/interface/bars/lifebar/HookableLifeBar.tscn")
var HookableManaBar = preload("res://demos/openRPG/src//combat/interface/bars/manabar/HookableManaBar.tscn")
